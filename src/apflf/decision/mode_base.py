    ...
    *,
    ...
    if config.kind == "rl":
        ...
        return RLSupervisor(
            ...
            tau_enter_start=config.rl.tau_enter_start,
            tau_exit_start=config.rl.tau_exit_start,
            gate_warmup_timesteps=config.rl.gate_warmup_timesteps,
            ood_threshold=config.rl.ood_threshold,
            deterministic_eval=config.rl.deterministic_eval,
            checkpoint_timesteps_done=policy_bundle.checkpoint_timesteps_done,
            vehicle_length=vehicle_length,
            vehicle_width=vehicle_width,
